...
import { Button, Row, Col, Table, Space, Tooltip, Breadcrumb, Form, Flex } from 'antd';
...
// -- styles
import style from '@components/Product/Promotions/styles/style.module.scss';
...
// -- components
import ModalPromotions from '@components/Product/ModalPromotions/widgets/Default';

const ProductPromotionsView = (props) => {
  ...
  const columns = [
    ...
    //   align: 'left',
    //   width: 160,
    //   render: (c) => (typeof c === 'number' ? `${c} Product` : '-')
    // },
    {
      title: 'Action',
      key: 'action',
    ...
    <>
      ...
      <section className={style.menu}>
        <div className='row-container'>
          <Breadcrumb items={[{ title: <Link href='/product'>Product</Link> }, { title: 'Promotions' }]} />
        </div>
...
export default ProductPromotionsView;
