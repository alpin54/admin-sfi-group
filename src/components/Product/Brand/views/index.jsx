...
// -- components
import ModalBrand from '@components/Product/ModalBrand/widgets/Default';

const ProductBrandView = (props) => {
    ...
    <>
      ...
      <section className={style.menu}>
        <div className='row-container'>
          <Breadcrumb items={[{ title: <Link href='/product'>Product</Link> }, { title: 'Brand' }]} />
        </div>
