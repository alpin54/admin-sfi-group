...
// -- models
import modalBannerModel from '@components/Footer/ModalMenu5/models';

// -- components
import ModalBannerFooterView from '@components/Footer/ModalMenu5/views';

const FooterModalMenu5Widget = (props) => {
...
export default FooterModalMenu5Widget;
