...
const ModalMenu5View = (props) => {
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-menu-5' loading={loading} disabled={loading}>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-menu-5' layout='vertical' onFinish={handleFinish} autoComplete='off'>
