...
// -- components
import ModalMenu4 from '@components/Footer/ModalMenu4/widgets/Default';
import { Color } from 'antd/es/color-picker';

const FormFooterSection4View = (props) => {
  ...
  return (
    <>
      <Card>
        <SectionHeader title='Menu 04' publish={data?.status} onPublish={() => handlePublish(data)} />
        <Form
          form={formInstance}
          id='form-footer-section4'
          layout='vertical'
            ...
            <Space size={16}>
              {isEdit ? (
                <>
                  ...
                  <Button type='primary' htmlType='submit' form='form-footer-section4' loading={loading}>
                    Save
                  </Button>
                </>
              ) : (
...
export default FormFooterSection4View;
