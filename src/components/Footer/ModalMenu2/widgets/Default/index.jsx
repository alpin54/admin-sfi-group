...
// -- models
import modalBannerModel from '@components/Footer/ModalMenu2/models';

// -- components
import ModalBannerFooterView from '@components/Footer/ModalMenu2/views';

const FooterModalMenu2Widget = (props) => {
...
export default FooterModalMenu2Widget;
