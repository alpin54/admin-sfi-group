...
const ModalMenu3View = (props) => {
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-menu-3' loading={loading} disabled={loading}>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-menu-3' layout='vertical' onFinish={handleFinish} autoComplete='off'>
