...
// -- components
import ModalMenu3 from '@components/Footer/ModalMenu3/widgets/Default';
import { Color } from 'antd/es/color-picker';

const FormFooterSection3View = (props) => {
  ...
  return (
    <>
      <Card>
        <SectionHeader title='Menu 03' publish={data?.status} onPublish={() => handlePublish(data)} />
        <Form
          form={formInstance}
          id='form-footer-section3'
          layout='vertical'
            ...
            <Space size={16}>
              {isEdit ? (
                <>
                  ...
                  <Button type='primary' htmlType='submit' form='form-footer-section3' loading={loading}>
                    Save
                  </Button>
                </>
              ) : (
...
export default FormFooterSection3View;
