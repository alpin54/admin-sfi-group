...
// -- components
import ModalMenu5 from '@components/Footer/ModalMenu5/widgets/Default';

const FormFooterSection5View = (props) => {
  ...
  return (
    <>
      <Card>
        <SectionHeader title='Menu 05' publish={data?.status} onPublish={() => handlePublish(data)} />
        <Form
          form={formInstance}
          id='form-footer-section5'
          layout='vertical'
            ...
            <Space size={16}>
              {isEdit ? (
                <>
                  ...
                  <Button type='primary' htmlType='submit' form='form-footer-section5' loading={loading}>
                    Save
                  </Button>
                </>
              ) : (
...
export default FormFooterSection5View;
