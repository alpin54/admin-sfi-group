...
const ModalMenu4View = (props) => {
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-menu-4' loading={loading} disabled={loading}>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-menu-4' layout='vertical' onFinish={handleFinish} autoComplete='off'>
