...
// -- styles
import style from '@components/Meta/FormSection4/styles/style.module.scss';

const FormMetaSection4View = (props) => {
  ...
  return (
    <Card>
      <SectionHeader title='Tracking Integration Settings' />
      <Form
        form={formInstance}
        id='form-tracking-integration'
        layout='vertical'
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-tracking-integration' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormMetaSection4View;
