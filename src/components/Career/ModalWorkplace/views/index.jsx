...
const ModalWorkplaceView = ({
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-workplace' loading={loading}>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-workplace' layout='vertical' onFinish={handleFinish} autoComplete='off'>
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: 'Please enter workplace name' }]}>
          <Input />
        </Form.Item>
      </Form>
    </Modal>
...
export default ModalWorkplaceView;
