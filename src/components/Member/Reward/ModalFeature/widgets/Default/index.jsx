...
// -- models
import modalRewardBannerModel from '@components/Member/Reward/ModalFeature/models';

// -- components
import ModalFeatureRewardView from '@components/Member/Reward/ModalFeature/views';
