...
// --styles
import style from '@components/Member/Drawer/styles/style.module.scss';
...
const DetailMemberDrawer = ({ open = false, onClose = () => {}, initialValues = {} }) => {
...
export default DetailMemberDrawer;
