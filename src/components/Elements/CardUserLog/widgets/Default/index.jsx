...
// -- data
import dummyData from '@components/Elements/CardUserLog/data';
...
const CardUserLogWidgets = (props) => {
  ...
  return <CardUserLogView {...props} createdData={dummyData.data || null} updatedData={dummyData.data || null} />;
};
