    ...
    <>
      ...
      <section id='voucher-form' className='section-form'>
        <div className='row-container'>
          <Breadcrumb
            items={[
              { title: <Link href='/dealer-setting'>Setting Voucher</Link> },
              {
                title:
                  action === 'add'
                    ? 'Add Voucher'
          ...
          <Row gutter={24}>
            ...
            <Col span={15}>
              ...
              <Collapse
                ...
                defaultActiveKey={['general-information', 'conditions', 'apply-discount-to']}
                items={[
                  {
                            ...
                            <Row gutter={[16, 16]}>
                                ...
                                <>
                                  <Col span={12}>
                                    <Form.Item
                                      ...
                                      rules={[{ required: true, message: 'Please input min spend amount!' }]}>
                                      <InputNumber
                                        min={0}
                                        step={1000}
                                        placeholder='Rp'
                                  ...
                                  <Col span={12}>
                                    <Form.Item
                                      ...
                                      rules={[{ required: true, message: 'Please input min spend discount!' }]}>
                                      <InputNumber
                                        min={0}
                                        step={1000}
                                        placeholder='Rp'
                              ...
                              {conditionType === 'min_spend_percentage' && (
                                <>
                                  ...
                                  <Col span={12}>
                                    <Form.Item
                                      name='min_spend_percentage'
                                      rules={[{ required: true, message: 'Please input min spend percentage!' }]}>
                                      <InputNumber min={1} max={100} suffix='%' disabled={viewOnly} />
                                    </Form.Item>
                                  </Col>
                                </>
            ...
            <Col span={9}>
              <Collapse
                expandIconPosition='end'
                expandIcon={() => <DownOutlined />}
                defaultActiveKey={['spending-target', 'visibility', 'quantity']}
                items={[
                  {
                    key: 'spending-target',
                    ...
                    children: (
                      <>
                        <Form.Item
                          label='Min. Target Spend'
                          rules={[{ required: true, message: 'Please input min target spend!' }]}>
                          <InputNumber
                            min={0}
                            step={1000}
                            placeholder='Rp'
                        ...
                        <Form.Item
                          label='Max. Target Spend'
                          rules={[{ required: true, message: 'Please input max target spend!' }]}>
                          <InputNumber
                            min={0}
                            step={1000}
                            placeholder='Rp'
