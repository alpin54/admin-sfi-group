...
// -- models
import dealerModel from '@components/Dealer/Pending/models';

// -- hooks
import useFirstLoad from '@hooks/useFirstLoad';

// -- components
import DealerPendingView from '@components/Dealer/Pending/views';

// -- data
import summary from '@components/Dealer/Pending/data/summary';
import dummyData from '@components/Dealer/Pending/data';

const DealerPendingWidget = () => {
...
export default DealerPendingWidget;
