...
const FormTermsConditionsSection2View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <SectionHeader title='Detail Terms & Conditions' publish={data?.status} onPublish={() => handlePublish(data)} />
      <Form
        form={formInstance}
        id='form-terms-conditions-section2'
        layout='vertical'
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-terms-conditions-section2' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormTermsConditionsSection2View;
