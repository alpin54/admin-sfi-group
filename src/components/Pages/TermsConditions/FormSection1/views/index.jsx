...
const FormTermsConditionsSection1View = (props) => {
  ...
  return (
    <Card loading={ready}>
      ...
      <Form
        form={formInstance}
        id='form-terms-conditions-section1'
        layout='vertical'
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-terms-conditions-section1' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormTermsConditionsSection1View;
