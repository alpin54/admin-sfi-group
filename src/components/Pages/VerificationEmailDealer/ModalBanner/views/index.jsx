...
const ModalBannerVerifyEmailDealerView = (props) => {
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-banner-verification'>
        Save
      </Button>
    </>
  );
...
export default ModalBannerVerifyEmailDealerView;
