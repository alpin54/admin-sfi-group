...
const FormVerificationEmailDealerView = (props) => {
  ...
  return (
    <>
      ...
      {notificationHolder}
      <Card>
        <Form form={formInstance} id='verify-email-dealer' layout='vertical' onFinish={handleFinish} autoComplete='off'>
            ...
            {(lang) => (
              <>
                ...
                <Form.Item
                  ...
                  <TextEditor allowClear readOnly={!isEdit} />
                </Form.Item>
              </>
            )}
          </TranslationTabs>
          <Form.Item>
            <Space size={16}>
              {isEdit ? (
                <Button type='primary' htmlType='submit' form='verify-email-dealer' loading={loading}>
                  Save
                </Button>
              ) : (
...
export default FormVerificationEmailDealerView;
