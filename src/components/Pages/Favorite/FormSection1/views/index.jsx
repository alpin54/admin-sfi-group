...
const FormFavoriteSection1View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <SectionHeader title='Favorite Empty' />
      <Form
        form={formInstance}
        id='form-favorite-section1'
        layout='vertical'
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-favorite-section1' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormFavoriteSection1View;
