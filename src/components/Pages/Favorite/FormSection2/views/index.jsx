...
const FormFavoriteSection2View = (props) => {
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-favorite-section2' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormFavoriteSection2View;
