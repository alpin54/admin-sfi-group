...
const FormFaqSection1View = (props) => {
  ...
  return (
    <Card loading={ready}>
      ...
      <Form form={formInstance} id='form-faq-section1' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          {(lang) => (
            <>
              ...
              <Form.Item
                ...
                <Input allowClear rows={3} readOnly={!isEdit} />
              </Form.Item>
            </>
          )}
        </TranslationTabs>
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-faq-section1' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormFaqSection1View;
