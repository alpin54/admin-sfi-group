...
const FormPrivacyPolicySection1View = (props) => {
  ...
  return (
    <Card loading={ready}>
      ...
      <Form
        form={formInstance}
        id='form-privacy-policy-section1'
        layout='vertical'
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-privacy-policy-section1' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormPrivacyPolicySection1View;
