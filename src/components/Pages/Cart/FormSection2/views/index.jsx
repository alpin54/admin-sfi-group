...
const FormCarSection2View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <SectionHeader title='Cart Empty' />
      <Form form={formInstance} id='form-cart-section2' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          {(lang) => (
            <>
              ...
              <Form.Item
                ...
                <TextArea allowClear rows={2} readOnly={!isEdit} />
              </Form.Item>
            </>
          )}
        </TranslationTabs>
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-cart-section2' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormCarSection2View;
