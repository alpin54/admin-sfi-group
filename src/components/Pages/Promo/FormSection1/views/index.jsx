...
const FormPromoSection1View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <SectionHeader title='Promo Empty' />
      <Form form={formInstance} id='form-promo-section1' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-promo-section1' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormPromoSection1View;
