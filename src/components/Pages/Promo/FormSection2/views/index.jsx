...
const FormPromoSection2View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <Form form={formInstance} id='form-promo-section2' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-promo-section2' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormPromoSection2View;
