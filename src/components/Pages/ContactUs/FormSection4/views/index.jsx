...
// -- components
import ModalSocialMedia from '@components/Pages/ContactUs/ModalSocialMedia/widgets/Default';

const FormContactUsSection4View = (props) => {
  ...
  return (
    <>
      <Card>
        <SectionHeader title='Social Media' publish={data?.status} onPublish={() => handlePublish(data)} />
        <Form
          form={formInstance}
          id='form-contact-section4'
          layout='vertical'
            ...
            <Space size={16}>
              {isEdit ? (
                <>
                  ...
                  <Button type='primary' htmlType='submit' form='form-contact-section4' loading={loading}>
                    Save
                  </Button>
                </>
              ) : (
...
export default FormContactUsSection4View;
