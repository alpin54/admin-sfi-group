...
// -- components
import ModalEcommerce from '@components/Pages/ContactUs/ModalEcommerce/widgets/Default';

const FormContactUsSection5View = (props) => {
  ...
  return (
    <>
      <Card>
        <SectionHeader title='Ecommerce' publish={data?.status} onPublish={() => handlePublish(data)} />
        <Form
          form={formInstance}
          id='form-contact-section5'
          layout='vertical'
            ...
            <Space size={16}>
              {isEdit ? (
                <>
                  ...
                  <Button type='primary' htmlType='submit' form='form-contact-section5' loading={loading}>
                    Save
                  </Button>
                </>
              ) : (
...
export default FormContactUsSection5View;
