...
// -- components
import ModalContact from '@components/Pages/ContactUs/ModalContact/widgets/Default';

const FormContactUsSection3View = (props) => {
            ...
            <Space size={16}>
              {isEdit ? (
                <>
                  ...
                  <Button type='primary' htmlType='submit' form='form-contact-section3' loading={loading}>
                    Save
                  </Button>
                </>
              ) : (
...
export default FormContactUsSection3View;
