...
const ModalBannerContactUsView = (props) => {
  const {
    method = 'edit',
    open,
    onClose,
  ...
  const title = method === 'edit' ? 'Edit Contact Item' : 'New Contact Item';
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-contact-item' loading={loading} disabled={loading}>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-contact-item' layout='vertical' onFinish={handleFinish} autoComplete='off'>
        <Form.Item name='id' hidden>
          <Input />
        </Form.Item>

        <Form.Item name='value' label='Content' rules={[{ required: true, message: 'Content is required' }]}>
          <Input />
        </Form.Item>
      </Form>
    </Modal>
...
export default ModalBannerContactUsView;
