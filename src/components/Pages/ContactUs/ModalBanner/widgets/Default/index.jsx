...
// -- models
import modalBannerModel from '@components/Pages/ContactUs/ModalBanner/models';

// -- components
import ModalBannerContactUsView from '@components/Pages/ContactUs/ModalBanner/views';
