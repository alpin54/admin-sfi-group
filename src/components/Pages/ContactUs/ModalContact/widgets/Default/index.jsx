...
// -- models
import modalBannerModel from '@components/Pages/ContactUs/ModalContact/models';

// -- components
import ModalBannerContactUsView from '@components/Pages/ContactUs/ModalContact/views';
