...
// -- models
import modalBannerModel from '@components/Pages/ContactUs/ModalEcommerce/models';

// -- components
import ModalBannerContactUsView from '@components/Pages/ContactUs/ModalEcommerce/views';
