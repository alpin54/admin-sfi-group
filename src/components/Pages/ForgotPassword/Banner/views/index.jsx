...
// -- components
import ModalBanner from '@components/Pages/ForgotPassword/ModalBanner/widgets/Default';

const ForgotPasswordBannerView = (props) => {
  // Integrations
...
export default ForgotPasswordBannerView;
