...
const FormShippingInformationSection1View = (props) => {
  ...
  return (
    <Card loading={ready}>
      ...
      <Form
        form={formInstance}
        id='form-shipping-information-section1'
        layout='vertical'
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-shipping-information-section1' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormShippingInformationSection1View;
