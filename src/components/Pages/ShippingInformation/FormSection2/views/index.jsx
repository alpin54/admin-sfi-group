...
const FormShippingInformationSection2View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <SectionHeader title='Detail Shipping Information' publish={data?.status} onPublish={() => handlePublish(data)} />
      <Form
        form={formInstance}
        id='form-shipping-information-section2'
        layout='vertical'
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-shipping-information-section2' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormShippingInformationSection2View;
