...
const FormSignUpView = (props) => {
  ...
  return (
    <>
      ...
      {notificationHolder}
      <Card>
        <Form form={formInstance} id='form-sign-up' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          <Form.Item>
            <Space size={16}>
              {isEdit ? (
                <Button type='primary' htmlType='submit' form='form-sign-up' loading={loading}>
                  Save
                </Button>
              ) : (
