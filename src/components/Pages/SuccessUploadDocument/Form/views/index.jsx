...
const FormSuccessUploadDocumentView = (props) => {
      ...
      <Card>
        <Form
          ...
          <Form.Item>
            <Space size={16}>
              {isEdit ? (
                <Button type='primary' htmlType='submit' form='success-upload-document' loading={loading}>
                  Save
                </Button>
              ) : (
...
export default FormSuccessUploadDocumentView;
