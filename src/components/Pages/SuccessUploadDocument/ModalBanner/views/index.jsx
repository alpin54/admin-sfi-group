...
const ModalBannerSuccessUploadDocumentView = (props) => {
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-banner-success-upload-document'>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form
        form={formInstance}
        id='form-banner-success-upload-document'
        layout='vertical'
...
export default ModalBannerSuccessUploadDocumentView;
