...
// -- components
import ModalBanner from '@components/Pages/SuccessUploadDocument/ModalBanner/widgets/Default';

const BannerSuccessUploadDocumentView = (props) => {
...
export default BannerSuccessUploadDocumentView;
