...
const ModalRecruitmentView = (props) => {
  ...
  const title = method === 'add' ? 'Add Recruitment' : method === 'edit' ? 'Edit Recruitment' : 'Detail Recruitment';
...
export default ModalRecruitmentView;
