...
// -- models
import modalImageModel from '@components/Pages/Career/ModalBenefit/models';

// -- components
import ModalBannerCareerView from '@components/Pages/Career/ModalBenefit/views';
...
const CareerModalBannerWidget = (props) => {
  ...
  return <ModalBannerCareerView {...props} />;
};
