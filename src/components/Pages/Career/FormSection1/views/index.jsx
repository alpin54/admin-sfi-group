...
const FormCareerSection1View = (props) => {
  ...
  return (
    <Card loading={ready}>
      ...
      <Form form={formInstance} id='form-career-section1' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-career-section1' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormCareerSection1View;
