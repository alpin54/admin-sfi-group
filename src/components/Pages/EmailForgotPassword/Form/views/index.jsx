...
const FormEmailForgotPasswordView = (props) => {
  ...
  return (
    <>
      ...
      {notificationHolder}
      <Card>
        <Form form={formInstance} id='form-email-forgot' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          <Form.Item>
            <Space size={16}>
              {isEdit ? (
                <Button type='primary' htmlType='submit' form='form-email-forgot' loading={loading}>
                  Save
                </Button>
              ) : (
...
export default FormEmailForgotPasswordView;
