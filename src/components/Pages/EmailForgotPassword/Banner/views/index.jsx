...
// -- components
import ModalBanner from '@components/Pages/EmailForgotPassword/ModalBanner/widgets/Default';

const BannerEmailForgotPasswordView = (props) => {
...
export default BannerEmailForgotPasswordView;
