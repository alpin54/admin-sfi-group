...
const FormDetailOrderSection1View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <Form form={formInstance} id='form-detail-order' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-detail-order' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormDetailOrderSection1View;
