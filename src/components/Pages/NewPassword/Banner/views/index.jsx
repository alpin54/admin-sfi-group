...
// -- components
import ModalBanner from '@components/Pages/NewPassword/ModalBanner/widgets/Default';

const BannerNewPasswordView = (props) => {
  ...
  const dataColumns = useMemo(() => {
    const cols = [
      ...
      },
      {
        ...
        key: 'description',
        render: (_, record) => record?.description?.en || '-'
      }
    ];
...
export default BannerNewPasswordView;
