...
const FormReturnRefundPolicySection2View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <SectionHeader
        title='Detail Return & Refund Policy'
        publish={data?.status}
        onPublish={() => handlePublish(data)}
      />
      <Form
        form={formInstance}
        id='form-return-refund-policy-section2'
        layout='vertical'
          ...
          <Space size={16}>
            {isEdit ? (
              <>
                ...
                <Button type='primary' htmlType='submit' form='form-return-refund-policy-section2' loading={loading}>
                  Save
                </Button>
              </>
            ) : (
...
export default FormReturnRefundPolicySection2View;
