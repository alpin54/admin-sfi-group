...
// -- components
import ModalSlideImage1 from '@components/Pages/AboutUs/ModalSlideImage1/widgets/Default';
...
const FormAboutUsSection7View = (props) => {
  ...
  return (
    <>
      ...
      {notificationHolder}
      <Card>
        <SectionHeader title='Slide Image 01' publish={data?.status} onPublish={() => handlePublish(data)} />
        <TranslationTabs>
...
export default FormAboutUsSection7View;
