...
// -- components
import ModalSlideImage2 from '@components/Pages/AboutUs/ModalSlideImage2/widgets/Default';
...
const FormAboutUsSection8View = (props) => {
  ...
  return (
    <>
      ...
      {notificationHolder}
      <Card>
        <SectionHeader title='Slide Image 02' publish={data?.status} onPublish={() => handlePublish(data)} />
        <TranslationTabs>
...
export default FormAboutUsSection8View;
