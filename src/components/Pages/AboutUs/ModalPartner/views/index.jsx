...
const ModalPartnerView = (props) => {
  ...
  const title = method === 'add' ? 'Add Partners' : method === 'edit' ? 'Edit Partners' : 'Detail Partners';
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-partners'>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-partners' layout='vertical' onFinish={handleFinish} autoComplete='off'>
...
export default ModalPartnerView;
