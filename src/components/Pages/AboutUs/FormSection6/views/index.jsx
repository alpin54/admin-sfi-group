...
// -- components
import ModalPartner from '@components/Pages/AboutUs/ModalPartner/widgets/Default';
...
const FormAboutUsSection6View = (props) => {
  ...
  return (
    <>
      ...
      {notificationHolder}
      <Card>
        <SectionHeader title='Partners' publish={data?.status} onPublish={() => handlePublish(data)} />
...
export default FormAboutUsSection6View;
