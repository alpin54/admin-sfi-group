...
const ModalSlideImage1View = (props) => {
  ...
  const title =
    method === 'add'
      ? 'Add Slide Image Section 02'
      : method === 'edit'
        ? 'Edit Slide Image Section 02'
        : 'Detail Slide Image Section 02';
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-slide-image'>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-slide-image' layout='vertical' onFinish={handleFinish} autoComplete='off'>
...
export default ModalSlideImage1View;
