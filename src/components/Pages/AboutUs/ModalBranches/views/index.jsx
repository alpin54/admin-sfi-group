...
const ModalBranchesView = (props) => {
  ...
  const title = method === 'add' ? 'Add Branches' : method === 'edit' ? 'Edit Branches' : 'Detail Branches';
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-branches'>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-branches' layout='vertical' onFinish={handleFinish} autoComplete='off'>
...
export default ModalBranchesView;
