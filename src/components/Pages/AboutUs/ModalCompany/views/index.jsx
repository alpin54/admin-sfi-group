...
const ModalCompanyView = (props) => {
  ...
  const title =
    method === 'add' ? 'Add Group Company' : method === 'edit' ? 'Edit Group Company' : 'Detail Group Company';
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-group-company'>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form form={formInstance} id='form-group-company' layout='vertical' onFinish={handleFinish} autoComplete='off'>
...
export default ModalCompanyView;
