...
const ModalStoryView = (props) => {
  ...
  const title = method === 'add' ? 'Add Story' : method === 'edit' ? 'Edit Story' : 'Detail Story';
    ...
    <Modal
      ...
      <Form form={formInstance} id='form-about-us' layout='vertical' onFinish={handleFinish} autoComplete='off'>
        ...
        <TranslationTabs>
          {(lang) => (
            <>
              <Form.Item label='Year' name={['year', lang]} rules={[{ required: true, message: 'Please input year!' }]}>
                <Input />
              </Form.Item>
              <Form.Item
                label='Title'
