...
const FormAboutUsSection2View = (props) => {
  ...
  return (
    <Card loading={ready}>
      <SectionHeader title='Our Mission' publish={data?.status} onPublish={() => handlePublish(data)} />
      <Form
        form={formInstance}
        ...
        <Form.Item name='description' label='Description' rules={[{ required: true, message: 'Title is required' }]}>
