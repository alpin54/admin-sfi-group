...
// -- components
import ModalVisionMission from '@components/Pages/AboutUs/ModalVisionMission/widgets/Default';
...
const FormAboutUsSection2View = (props) => {
  ...
  return (
    <>
      ...
      {notificationHolder}
      <Card>
        <SectionHeader title='Vision & Mission' publish={data?.status} onPublish={() => handlePublish(data)} />
        <Form form={formInstance} layout='vertical' autoComplete='off' onFinish={handleFinish} initialValues={data}>
          ...
          <TranslationTabs>
            {(lang) => (
              <>
                <Form.Item
                  name={['title_vision', lang]}
                  label='Title Vision'
                  rules={[{ required: true, message: 'Title is required' }]}>
                  <Input allowClear readOnly={!isEdit} />
                </Form.Item>
                <Form.Item
                  name={['description_vision', lang]}
                  label=' Vision Description'
                  rules={[{ required: true, message: 'Description is required' }]}>
                  <Input allowClear readOnly={!isEdit} />
                </Form.Item>
                <Form.Item
                  name={['title_mission', lang]}
                  label=' Title Mission'
                  rules={[{ required: true, message: 'Title is required' }]}>
                  <Input allowClear readOnly={!isEdit} />
                </Form.Item>
...
export default FormAboutUsSection2View;
