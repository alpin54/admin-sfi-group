...
const FormVerificationEmailMemberView = (props) => {
  ...
  return (
    <>
      ...
      {notificationHolder}
      <Card>
        <Form form={formInstance} id='verify-email-member' layout='vertical' onFinish={handleFinish} autoComplete='off'>
          ...
          <Form.Item>
            <Space size={16}>
              {isEdit ? (
                <Button type='primary' htmlType='submit' form='verify-email-member' loading={loading}>
                  Save
                </Button>
              ) : (
...
export default FormVerificationEmailMemberView;
