...
// -- components
import ModalBanner from '@components/Pages/VerificationEmailMember/ModalBanner/widgets/Default';

const BannerVerificationEmailView = (props) => {
...
export default BannerVerificationEmailView;
