...
const FormSuccessCreateAccountView = (props) => {
  ...
  return (
    <>
      ...
      <Card>
        <Form
          form={formInstance}
          id='form-success-create-account'
          layout='vertical'
          ...
          <Form.Item>
            <Space size={16}>
              {isEdit ? (
                <Button type='primary' htmlType='submit' form='form-success-create-account' loading={loading}>
                  Save
                </Button>
              ) : (
...
export default FormSuccessCreateAccountView;
