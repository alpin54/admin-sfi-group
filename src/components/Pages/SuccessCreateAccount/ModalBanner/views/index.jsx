...
const ModalBannerSuccessCreateAccountView = (props) => {
  ...
  const footerComponent = (
    <>
      ...
      <Button type='primary' htmlType='submit' form='form-success-create-account-banner'>
        Save
      </Button>
    </>
  );
  ...
  return (
    <Modal
      ...
      <Form
        form={formInstance}
        id='form-success-create-account-banner'
        layout='vertical'
...
export default ModalBannerSuccessCreateAccountView;
