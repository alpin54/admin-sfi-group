...
const ShippingReturnView = (props) => {
        ...
        <div className='row-container'>
          <Breadcrumb
            items={[
              ...
              { title: method === 'edit' ? 'Edit Shipping Information' : 'Detail Shipping Information' }
            ]}
          />
        </div>
            ...
            <Form
              ...
              <Form.Item>
                <Space size={16}>
                  ...
                  {isEdit ? (
                    <Button type='primary' htmlType='submit' form='form-shipping-information' loading={loading}>
                      Save
                    </Button>
                  ) : (
...
export default ShippingReturnView;
